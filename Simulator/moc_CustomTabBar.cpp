...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CustomTabBar_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_CustomTabBar_t qt_meta_stringdata_CustomTabBar = {
    {
        QT_MOC_LITERAL(0, 12),  // "CustomTabBar"
        QT_MOC_LITERAL(13, 10),  // "scrolledUp"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 12)   // "scrolledDown"
    },
    "CustomTabBar",
    "scrolledUp",
    "",
...
void CustomTabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->scrolledUp(); break;
        case 1: _t->scrolledDown(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomTabBar::*)();
            if (_t _q_method = &CustomTabBar::scrolledUp; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomTabBar::*)();
            if (_t _q_method = &CustomTabBar::scrolledDown; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CustomTabBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_CustomTabBar.offsetsAndSizes,
    qt_meta_data_CustomTabBar,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_CustomTabBar_t
, QtPrivate::TypeAndForceComplete<CustomTabBar, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void CustomTabBar::scrolledUp()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CustomTabBar::scrolledDown()
{
