...
class XORGate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "XORGate.json")
    Q_INTERFACES(AbstractConInterface)
public:
    explicit XORGate();
    explicit XORGate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"XORGate"};
