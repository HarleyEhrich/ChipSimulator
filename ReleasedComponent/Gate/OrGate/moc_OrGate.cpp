/****************************************************************************
** Meta object code from reading C++ file 'OrGate.h'
**
...
#error "The header file 'OrGate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_OrGate_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_OrGate_t qt_meta_stringdata_OrGate = {
    {
        QT_MOC_LITERAL(0, 6),  // "OrGate"
...
const QMetaObject OrGate::staticMetaObject = { {
    ...
    qt_meta_stringdata_OrGate.offsetsAndSizes,
    qt_meta_data_OrGate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_OrGate_t
, QtPrivate::TypeAndForceComplete<OrGate, std::true_type>
...
static constexpr unsigned char qt_pluginMetaDataV2_OrGate[] = {
    0xbf, 
    // "IID"
    ...
    't',  'e',  'r',  'f',  'a',  'c',  'e', 
    // "className"
    0x03,  0x66,  'O',  'r',  'G',  'a',  't',  'e', 
    // "MetaData"
    0x04,  0xa1,  0x64,  'K',  'e',  'y',  's',  0x80, 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN_V2(OrGate, OrGate, qt_pluginMetaDataV2_OrGate)
#else
QT_PLUGIN_METADATA_SECTION
static constexpr unsigned char qt_pluginMetaData_OrGate[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
...
QT_MOC_EXPORT_PLUGIN(OrGate, OrGate)
