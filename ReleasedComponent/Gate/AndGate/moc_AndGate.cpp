/****************************************************************************
** Meta object code from reading C++ file 'AndGate.h'
**
...
#error "The header file 'AndGate.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AndGate_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_AndGate_t qt_meta_stringdata_AndGate = {
    {
        QT_MOC_LITERAL(0, 7),  // "AndGate"
...
void AndGate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AndGate *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->run(); break;
        default: ;
...
const QMetaObject AndGate::staticMetaObject = { {
    ...
    qt_meta_stringdata_AndGate.offsetsAndSizes,
    qt_meta_data_AndGate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AndGate_t
, QtPrivate::TypeAndForceComplete<AndGate, std::true_type>
...
static constexpr unsigned char qt_pluginMetaDataV2_AndGate[] = {
    0xbf, 
    // "IID"
    ...
    't',  'e',  'r',  'f',  'a',  'c',  'e', 
    // "className"
    0x03,  0x67,  'A',  'n',  'd',  'G',  'a',  't', 
    'e', 
    // "MetaData"
    0x04,  0xa1,  0x64,  'K',  'e',  'y',  's',  0x80, 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN_V2(AndGate, AndGate, qt_pluginMetaDataV2_AndGate)
#else
QT_PLUGIN_METADATA_SECTION
static constexpr unsigned char qt_pluginMetaData_AndGate[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
...
QT_MOC_EXPORT_PLUGIN(AndGate, AndGate)
