#ifndef REGISTERZHTICKUPDATE_H
#define REGISTERZHTICKUPDATE_H
...
class RegisterZHTickUpdate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "RegisterZHTickUpdate.json")
    Q_INTERFACES(AbstractConInterface)

public:
    explicit RegisterZHTickUpdate();
    explicit RegisterZHTickUpdate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"RegisterZHTickUpdate"};
