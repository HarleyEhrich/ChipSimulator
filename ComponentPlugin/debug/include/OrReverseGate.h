#ifndef ORREVERSEGATE_H
#define ORREVERSEGATE_H
...
class OrReverseGate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "OrReverseGate.json")
    Q_INTERFACES(AbstractConInterface)
public:
    explicit OrReverseGate();
    explicit OrReverseGate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"OrReverseGate"};
