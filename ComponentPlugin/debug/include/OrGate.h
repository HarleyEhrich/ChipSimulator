...
class OrGate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "OrGate.json")
    Q_INTERFACES(AbstractConInterface)
public:
    explicit OrGate();
    explicit OrGate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"OrGate"};
