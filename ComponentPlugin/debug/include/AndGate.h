...
class AndGate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "AndGate.json")
    Q_INTERFACES(AbstractConInterface)
public:
    explicit AndGate();
    explicit AndGate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"AndGate"};
