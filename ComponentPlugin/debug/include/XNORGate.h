...
class XNORGate : public AbstractConInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID AbstractConInterface_iid FILE "XNORGate.json")
    Q_INTERFACES(AbstractConInterface)
public:
    explicit XNORGate();
    explicit XNORGate(long sceneID, QGraphicsItem *parent = nullptr, QObject* parentObject=nullptr);
...
private:
    inline static const QString __xmlLabel{"XNORGate"};
